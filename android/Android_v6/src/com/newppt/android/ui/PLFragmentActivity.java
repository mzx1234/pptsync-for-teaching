...
//		TongbuTagFragment tongbuFragment = new TongbuTagFragment();
		BiJiTagFragment biJiTagFragment = new BiJiTagFragment();
//		XiazaiTagFragment xiazaiFragment = new XiazaiTagFragment();
		YuanBanTagFragment yuanBanTagFragment = new YuanBanTagFragment();

//		fragmentList.add(tongbuFragment);
		fragmentList.add(biJiTagFragment);
//		fragmentList.add(xiazaiFragment);
		fragmentList.add(yuanBanTagFragment);
